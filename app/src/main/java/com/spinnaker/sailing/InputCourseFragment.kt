...
class InputCourseFragment : Fragment(),  View.OnClickListener{
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_input_course, container, false)
    }
    ...
    override fun onClick(v: View?) {
        when(v!!.id){
            ...
            R.id.right_btn -> navController!!.navigate(R.id.action_inputCourseFragment_to_setWindFragment)
