...
class SetWindFragment : Fragment(),  View.OnClickListener{
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_set_wind, container, false)
    }
    ...
    override fun onClick(v: View?) {
        when(v!!.id){
            ...
            R.id.right_btn -> navController.navigate(R.id.action_setWindFragment_to_checkLineFragment)
