 ...
 * Use the [NextLegFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class NextLegFragment : Fragment(), View.OnClickListener{
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_next_leg, container, false)
    }
    ...
    override fun onClick(v: View?) {
        when(v!!.id){
            ...
            R.id.right_btn -> navController.navigate(R.id.action_nextLegFragment_to_finishFragment)
