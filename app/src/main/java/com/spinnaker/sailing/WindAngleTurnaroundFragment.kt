 ...
 * Use the [WindAngleTurnaroundFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class WindAngleTurnaroundFragment : Fragment(), View.OnClickListener{
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wind_angle_turnaround, container, false)
    }
